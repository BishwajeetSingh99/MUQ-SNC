...
python3.12 {MUQSAC}/soln2ck_2.py --mechanism=mechanism.inp --thermo=thermo.dat {mech} &> soln2ck.out
python3.12 cantera_.py &> solve
...
find . -type f \( -name 'time_history.csv' -o -name 'ScanMan.log' \) -delete &> delete2.log
		...
		s_convert = """#!/bin/bash
python3.12 /home/krithika/Desktop/KineticMechanismOptimization/sc_v2/v2.1/soln2ck.py &>sol2yaml_out
...
rm -f ScanMan.log
		...
		s_run = """#!/bin/bash
python3.12 {MUQSAC}/soln2ck_FM.py --mechanism=mechanism.inp --thermo=therm.dat --transport=trans.dat {mech} &> soln2ck.log 
{Bin}/ScanMan -i mechanism.inp -t {thermo_file} -m {trans_file} -f chemkin -3sr -N 0.05 -E -o mechanism.pre &> ScanMan.log
{Bin}/FlameMan &> Flame.log && python3.12 extract.py &> extract.log
